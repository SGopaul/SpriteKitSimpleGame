...
- (void)addMonster {
    ...
    monster.physicsBody.dynamic = YES; // the physics engine will not coontrol the movement of the monster
    monster.physicsBody.categoryBitMask = monsterCategory; // defines the category
    monster.physicsBody.contactTestBitMask = projectileCategory; // indicate category of object it can interact and then notify (delegate)
